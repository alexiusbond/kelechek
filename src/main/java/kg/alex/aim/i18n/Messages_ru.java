package kg.alex.aim.i18n;

public class Messages_ru extends kg.alex.aim.i18n.Messages {
    ...
    static final Object[][] contents_ru = {
            ...
            {Materials, "Материалы"},
            {Contract, "Контракт"},
            {ContractPrimaryKG, "Контракт для младших классов (KG)"},
            {ContractSeniorKG, "Контракт для старших классов (KG)"},
            {ContractRU, "Контракт 2025 (RU)"},
            {ContractKG, "Контракт 2025 (KG)"},
            {InternalRules, "Внутренние правила"},
            {Discount, "Скидка"},
            ...
            {PaidPercentage, "Оплаченный процент"},
