...
import kg.alex.aim.dao.DbBranch;
import kg.alex.aim.dao.DbDefinition;
import kg.alex.aim.dao.DbEmployee;
import kg.alex.aim.dao.DbEmployeeLessons;
import kg.alex.aim.domain.EmployeeBranchesExcel;
import kg.alex.aim.domain.EmployeeLessons;
import kg.alex.aim.excel.ExcelUploader;
import kg.alex.aim.i18n.Messages;
import kg.alex.aim.pdf.BranchCodesPdf;
        ...
        if (source == deleteBtn && yearSelect.getValue() != null) {
            ...
            try {
                myUI.getPage().open(new FileResource(
                                new File(Settings.PATH_TO_UPLOADS + "ellipse_hr_branches.xlsx")),
                        "_blank", false);
            } catch (Exception e) {
                logger.error(e);
                logger.catching(e);
