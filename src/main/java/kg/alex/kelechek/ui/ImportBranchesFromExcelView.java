...
import kg.alex.kelechek.dao.DbBranch;
import kg.alex.kelechek.dao.DbDefinition;
import kg.alex.kelechek.dao.DbEmployee;
import kg.alex.kelechek.dao.DbEmployeeLessons;
import kg.alex.kelechek.domain.EmployeeBranchesExcel;
import kg.alex.kelechek.domain.EmployeeLessons;
import kg.alex.kelechek.excel.ExcelUploader;
import kg.alex.kelechek.i18n.Messages;
import kg.alex.kelechek.pdf.BranchCodesPdf;
import kg.alex.kelechek.utils.FormattedFilterTable;
        ...
        if (source == deleteBtn && yearSelect.getValue() != null) {
            ...
            try {
                myUI.getPage().open(new FileResource(
                                new File(Settings.PATH_TO_UPLOADS + "abl_hr_branches.xlsx")),
                        "_blank", false);
            } catch (Exception e) {
                logger.error(e);
                logger.catching(e);
