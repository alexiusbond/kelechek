...
import kg.alex.kelechek.domain.Employee;
import kg.alex.kelechek.domain.EmployeeExtraInfo;
import kg.alex.kelechek.i18n.Messages;
import kg.alex.kelechek.pdf.CVPdf;
...
public class EmployeeCvWindow extends Window {
    ...
    public EmployeeCvWindow(MyVaadinUI myUI, Employee employee, EmployeeExtraInfo employeeExtraInfo, String year) {
        ...
        rowNum++;
        rightGl.addComponent(createLabel("<b>" +
                                         myUI.getMessage(Messages.KelechekWorkExperience) + ": </b>" + employeeExtraInfo.getWorkExperienceSapat(), null),
                0, rowNum, 1, rowNum);
        rowNum++;
        rightGl.addComponent(createLabel("<b>" +
