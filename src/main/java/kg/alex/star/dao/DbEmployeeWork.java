...
import kg.alex.star.domain.EmployeeWork;
...
public class DbEmployeeWork extends BaseDb {
    ...
    public IndexedContainer execSQL(final MyVaadinUI myUI, int employee_id, int own_id,
        ...
        while (result.next()) {
            ...
            item.getItemProperty(myUI.getMessage(Messages.StarEduComplex)).setValue(
                    edv.createCheckBox(result.getBoolean("ew.is_sapat"), myUI.getMessage(Messages.StarEduComplex)));
    ...
    public IndexedContainer execSQL(final MyVaadinUI myUI, int employee_id, int own_id) throws SQLException {
        ...
        container.addContainerProperty(myUI.getMessage(Messages.StarEduComplex), String.class, null);
        ...
        while (result.next()) {
            ...
            item.getItemProperty(myUI.getMessage(Messages.StarEduComplex)).setValue(result.getInt("ew.is_sapat") == 1 ?
