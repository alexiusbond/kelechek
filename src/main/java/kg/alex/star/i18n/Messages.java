...
public class Messages extends ListResourceBundle implements Serializable {
    ...
    public static final String StarWorkExperience = generateId();
    ...
    public static final String StarEduComplex = generateId();
    ...
    public static final String StarExam = generateId();
