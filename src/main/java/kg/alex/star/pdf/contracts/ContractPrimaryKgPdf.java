...
public class ContractPrimaryKgPdf {

    static final Logger logger = LogManager.getLogger(ContractPrimaryKgPdf.class);
    ...
    public ContractPrimaryKgPdf(final MyVaadinUI ui, StudentInfoPdf st_info, final IndexedContainer instPlanCont) {
        this.myUI = ui;
        ...
        StreamResource.StreamSource source1 = () -> {
            ...
            try {
                ...
                paragraph.add(Chunk.NEWLINE);
                paragraph.add(new Phrase("2.1.4. Окуучуну үч маал тамак (эртең мененки, түшкү жана түштөн кийинки чай) менен камсыз кылууга;", ordFont));
                paragraph.add(Chunk.NEWLINE);
                ...
                paragraph.add(Chunk.NEWLINE);
                paragraph.add(new Phrase("Ата-эненин Мектептин билим берүү процессине негизсиз кийлигишүүсү Мектептин ички тартип эрежелерин бузуу катары эсептелет жана мындай учурлар Келишимди бузууга негиз болот.", ordFont));
                paragraph.add(Chunk.NEWLINE);
                ...
                paragraph.add(Chunk.NEWLINE);
                paragraph.add(new Phrase("2.2.9. Билим берүү процессин жана Мектептин ишин маалымдоо максатында Окуучунун жана Ата-эненин уруксатын албастан жана билдирүү бербестен өзүнүн интернет-баракчаларына жана ЖМКга фото жана видеоматериалдарды жайгаштырууга;", ordFont));
                paragraph.add(Chunk.NEWLINE);
                ...
                paragraph.setLeading(13);
                paragraph.setAlignment(Element.ALIGN_JUSTIFIED);
                paragraph.add(new Phrase("3.1. Окуу төлөмүн төлөө бөлүктөргө бөлүнүү менен Келишимдин тиркемесине ылайык жүргүзүлөт. Биринчи бөлүгүн (баштапкы төлөм) төлөө Келишимди түзүүдө, калган бөлүгү окуу жылынын кийинки айларына пропорционалдуу түрдө бөлүү шарты менен төлөнөт. Мында баштапкы төлөм 30% (отуз) кем болбоого жана акыркы төлөм кийинки жылдын 31-мартынан кечиктирилбестен төлөнүүгө тийиш.", ordFont));
                paragraph.add(Chunk.NEWLINE);
    ...
    private static class myPageEvent extends PdfPageEventHelper {
        ...
        public myPageEvent(BaseFont baseFont) {
            this.f_font = new Font(baseFont, 10, Font.NORMAL);
        }
