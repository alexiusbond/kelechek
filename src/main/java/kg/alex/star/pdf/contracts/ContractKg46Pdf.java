...
import kg.alex.star.utils.money.WritableSummKgUSD;
...
public class ContractKg46Pdf {

    static final Logger logger = LogManager.getLogger(ContractKg46Pdf.class);
    ...
    public ContractKg46Pdf(final MyVaadinUI ui, StudentInfoPdf st_info, final IndexedContainer instPlanCont) {
        this.myUI = ui;
        ...
        StreamResource.StreamSource source1 = () -> {
            ...
            try {
                ...
                paragraph.add(new Phrase(" чейин Кыргыз Республикасынын мамлекеттик  билим берүүнүн тийиштүү деңгээлинин программалары боюнча окутуу, Келишимдин шарттарына ылайык тамак-аш менен камсыз кылуу жана көрсөтүлгөн кызматтар үчүн акы төлөө (мындан ары - окуу төлөмдөрү) болуп саналат.", ordFont));
                contractBody.add(paragraph);
                contractBody.add(new Paragraph(10, " "));
                ...
                paragraph.setIndentationRight(10);
                paragraph.setLeading(13);
                paragraph.add(new Phrase("2.1.3. Окуу мөөнөтү учурунда Окуучуну окуу китептери жана башка адабияттар, китепкана, лаборатория, компьютердик класстар менен камсыз кылууга;", ordFont));
                contractBody.add(paragraph);
                ...
                paragraph.setIndentationRight(10);
                paragraph.setLeading(13);
                paragraph.add(new Phrase("2.1.8. Мектеп тарабынан белгиленген көчүрүү жана жыйынтыктоочу аттестация сынактарын жүргүзүүгө жана көчүрүү аттестациясынын жыйынтыгы боюнча педагогикалык кеңештин чечимине ылайык Окуучуну белгиленген тартипте класстан класска көчүрүүгө;", ordFont));
                contractBody.add(paragraph);
                ...
                paragraph.setIndentationRight(10);
                paragraph.setLeading(13);
                paragraph.add(new Phrase("2.1.9. Окуучуну окутуунун 2–деңгээлин аяктаганда күбөлүк, ал эми 3–деңгээлин аяктаганда белгиленген үлгүдөгү аттестат менен камсыз кылууга;", ordFont));
                contractBody.add(paragraph);
                ...
                paragraph.setIndentationRight(10);
                paragraph.setLeading(13);
                paragraph.add(new Phrase("2.2.3. Окуучунун окуу жана тамактануусу үчүн ата-энелерден алына турган төлөмдүн өлчөмүн жылдык чыгымдардын сметасына жараша жыл сайын өз алдынча өзгөртүүгө;", ordFont));
                contractBody.add(paragraph);
                ...
                paragraph.setIndentationRight(10);
                paragraph.setLeading(13);
                paragraph.add(new Phrase("2.2.9. Билим берүү процессин жана Мектептин ишин маалымдоо максатында Окуучунун жана Ата-энесинин уруксатын албастан жана билдирүү бербестен өзүнүн интернет-баракчаларына жана ЖМКга фото жана видеоматериалдарды жайгаштырууга;", ordFont));
                contractBody.add(paragraph);
                ...
                paragraph.setIndentationRight(10);
                paragraph.setLeading(13);
                paragraph.add(new Phrase("2.3.5. Окуучуну Мектептин ички тартип эрежеси менен тааныштырууга. Окуучу Мектептин ички тартип эрежесин бузган учурда ага адекваттуу таасир этүүнү аткарууга;", ordFont));
                contractBody.add(paragraph);
                ...
                paragraph.setIndentationRight(10);
                paragraph.setLeading(13);
                paragraph.add(new Phrase("б) Мектеп тарабынан Келишимдин 2.1.1–2.1.10. пункттарында көрсөтүлгөн шарттар бузулган учурда.", ordFont));
                contractBody.add(paragraph);
                ...
                paragraph.setIndentationRight(10);
                paragraph.setLeading(13);
                paragraph.add(new Phrase("2.4.3. Мектепти алдын ала кабардар кылуу менен Окуучуну окутуу процессине катышууга жана ошондой эле Окуучу тууралуу ар кандай маалыматтарды алып турууга;", ordFont));
                contractBody.add(paragraph);
                ...
                paragraph.setLeading(13);
                paragraph.setAlignment(Element.ALIGN_JUSTIFIED);
                paragraph.add(new Phrase("3.1. Окуу төлөмүн төлөө бөлүктөргө бөлүнүү менен Келишимдин тиркемесине ылайык жүргүзүлөт. Биринчи бөлүгүн (баштапкы төлөм) төлөө Келишимди түзүүдө, калган бөлүгү окуу жылынын кийинки айларына пропорцианалдуу түрдө бөлүү шарты менен төлөнөт. Мында баштапкы төлөм 1000 (миң) АКШ долларынан кем болбоого жана акыркы төлөм кийинки жылдын 31-апрелинен кечиктирилбестен төлөнүүгө тийиш.", ordFont));
                contractBody.add(paragraph);
                ...
                paragraph.setIndentationRight(10);
                paragraph.setLeading(13);
                paragraph.add(new Phrase("3.6. Ата-эне окуучуну кечиримдүү себептерден улам Мектептен алып чыгып кете турган болсо, алдын ала төлөнгөн төлөмдөр кетирилген чыгашалар алынган соң калган сумманын 50% окуу жылынын аягына чейин кайтарылып берилет.", ordFont));
                contractBody.add(paragraph);
                ...
                paragraph.setLeading(13);
                paragraph.setAlignment(Element.ALIGN_JUSTIFIED);
                paragraph.add(new Phrase("5.5. Кийинки жылга академиялык карызы жок жана окуу мерчемин толук көлөмдө аткарган окуучулар которулат (окуган класс үчүн окуу мерчемин бардык окуу дисциплиналары боюнча чейрек белгилери бар 100 баллдын ичинен 40 баллдан төмөн эмес). Белгиленген окуу мерчеминдеги бир окуу дисциплинасы боюнча жылдык белгиси 40 баллдан төмөн болгон окуучулар педагогикалык кеңештин сунушуна жана Мектеп жетекчисинин буйругуна ылайык күзгү сыноого калтырылат. Эгерде күзгү сыноо ийгиликсиз болсо, Окуучу кийинки окуу жылына өтө албайт жана өткөн жылдагы окуу төлөмдүн ордун толтурбастан кайра окууга калат.", ordFont));
                contractBody.add(paragraph);
                ...
                paragraph.setLeading(13);
                paragraph.setAlignment(Element.ALIGN_JUSTIFIED);
                paragraph.add(new Phrase("5.6. Келишим боюнча бардык пикир келишпестиктер Тараптар тарабынан сүйлөшүү тартибинде чечилет. Талаш-тартышты сүйлөшүүлөр жолу менен чечүү мүмкүн болбогон учурда, алар Кыргыз Республикасынын мыйзамдарында белгиленген тартипте чечилет.", ordFont));
                contractBody.add(paragraph);
                ...
                paragraph.setLeading(13);
                paragraph.setAlignment(Element.ALIGN_JUSTIFIED);
                paragraph.add(new Phrase("5.7. Келишимди түзүүдө ата-энелер төмөнкү документтерди көрсөтүшү керек:", ordFont));
                contractBody.add(paragraph);
                ...
                paragraph.setLeading(13);
                paragraph.setAlignment(Element.ALIGN_JUSTIFIED);
                paragraph.add(new Phrase("5.8. Келишим эки нускада мамлекеттик тилде түзүлдү жана Тараптар тарабынан кол тамгалар коюлду. Эки нуска тең бирдей жана бирдей юридикалык күчкө ээ. Тараптардын ар биринде ушул келишимдин бирден нускасы болот.", ordFont));
                contractBody.add(paragraph);
