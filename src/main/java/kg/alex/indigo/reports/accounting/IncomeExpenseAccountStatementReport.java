...
import kg.alex.indigo.pdf.IncomeExpenseAccountStatementPdf;
...
public class IncomeExpenseAccountStatementReport implements Button.ClickListener,
    ...
    private void buildLeftPanel() {
        ...
        categoriesTable.setVisibleColumns(myUI.getMessage(IndigoMessages.Title));
        ...
        if (source == generateBtn) {
            if (categoriesTable.getValue() != null && currencySelect.isValid() && fromDateDF.isValid() && tillDateDF.isValid()) {
                try {
                    ...
                    dataTable.setColumnAlignment(myUI.getMessage(IndigoMessages.Income), Table.Align.RIGHT);
                    dataTable.setColumnAlignment(myUI.getMessage(IndigoMessages.Expense), Table.Align.RIGHT);
