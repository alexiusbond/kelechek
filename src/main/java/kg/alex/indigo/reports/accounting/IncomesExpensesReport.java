        ...
        if (source == generateBtn) {
            if (employeeCategoriesTable.getValue() != null && currencySelect.isValid() && fromDateDF.isValid() && tillDateDF.isValid()) {
                try {
                    ...
                    dataTable.setColumnAlignment(myUI.getMessage(IndigoMessages.Incomes), Table.Align.RIGHT);
                    dataTable.setColumnAlignment(myUI.getMessage(IndigoMessages.Expenses), Table.Align.RIGHT);
            ...
            try {
                EnhancedFormatExcelExport excelReport = new EnhancedFormatExcelExport(dataTable, myUI.getMessage(IndigoMessages.IncomesExpensesReport) + " ("
                        + currencySelect.getItemCaption(currencySelect.getValue()) + ")");
                excelReport.setReportTitle(myUI.getMessage(IndigoMessages.IncomesExpensesReport) + " ("
                        + currencySelect.getItemCaption(currencySelect.getValue()) + ") ");
