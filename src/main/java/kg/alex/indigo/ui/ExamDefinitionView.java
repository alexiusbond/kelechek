...
import kg.alex.indigo.dao.DbExam;
import kg.alex.indigo.domain.Exam;
...
public class ExamDefinitionView extends HorizontalSplitPanel implements Button.ClickListener,
    ...
    public ExamDefinitionView(MyVaadinUI myUI) {
        ...
        String[] NATURAL_COL_ORDER = new String[]{myUI.getMessage(IndigoMessages.Title),
                myUI.getMessage(IndigoMessages.ValidityMonths),
    ...
    private void buildSettingsLayout() {
        ...
        validityTF = new TextField(myUI.getMessage(IndigoMessages.ValidityMonths), property);
        validityTF.setStyleName(ValoTheme.TEXTFIELD_SMALL);
        validityTF.setRequired(true);
        validityTF.setRequiredError(myUI.getMessage(IndigoMessages.RequiredField));
    ...
    private void fillFields() {
        ...
        validityTF.getPropertyDataSource().setValue(dataTable.getContainerProperty(dataTable.getValue(),
                myUI.getMessage(IndigoMessages.ValidityMonths)).getValue());
    ...
    private void updateDataContainer() {
        ...
        dataTable.getContainerProperty(dataTable.getValue(),
                myUI.getMessage(IndigoMessages.ValidityMonths)).setValue(
    ...
    private void addDataContainerItem(int id) {
        ...
        item.getItemProperty(myUI.getMessage(IndigoMessages.Title)).setValue(
                nameTF.getValue());
        item.getItemProperty(myUI.getMessage(IndigoMessages.ValidityMonths)).setValue(
                validityTF.getPropertyDataSource().getValue());
