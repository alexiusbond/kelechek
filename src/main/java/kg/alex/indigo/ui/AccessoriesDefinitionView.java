...
import kg.alex.indigo.dao.DbAccessories;
import kg.alex.indigo.dao.DbDefinition;
import kg.alex.indigo.domain.Accessories;
...
public class AccessoriesDefinitionView extends HorizontalSplitPanel implements Button.ClickListener,
    ...
    public AccessoriesDefinitionView(MyVaadinUI myUI) {
        ...
        String[] NATURAL_COL_ORDER = new String[]{myUI.getMessage(IndigoMessages.Title),
                myUI.getMessage(IndigoMessages.Category), myUI.getMessage(IndigoMessages.Status)};
        buildSettingsLayout();
