...
import kg.alex.indigo.dao.DbStock;
import kg.alex.indigo.domain.Stock;
...
public class StockDefinitionView extends HorizontalSplitPanel implements Button.ClickListener,
    ...
    public StockDefinitionView(MyVaadinUI myUI) {
        ...
        String[] NATURAL_COL_ORDER = new String[]{myUI.getMessage(IndigoMessages.Title), myUI.getMessage(IndigoMessages.Status)};
        buildSettingsLayout();
