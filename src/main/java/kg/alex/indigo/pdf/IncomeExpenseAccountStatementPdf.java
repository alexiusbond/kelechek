        ...
        StreamResource.StreamSource source1 = new StreamResource.StreamSource() {
            ...
            public InputStream getStream() {
                ...
                try {
                    ...
                    Paragraph spr = new Paragraph(myUI.getMessage(IndigoMessages.IncomeExpenseAccountStatementReport) + " "
                    ...
                    dataTable.addCell(new Phrase(myUI.getMessage(IndigoMessages.Income), ordFontBold));
                    dataTable.addCell(new Phrase(myUI.getMessage(IndigoMessages.Expense), ordFontBold));
                    ...
                    while (iter.hasNext()) {
                        ...
                        if (t.getContainerProperty(next, myUI.getMessage(IndigoMessages.Income)).getValue() != null) {
                            dataTable.addCell(new Phrase(Settings.dFormat2.format(t.getContainerProperty(next,
                                    myUI.getMessage(IndigoMessages.Income)).getValue()), tableFont));
                        } else {
                            dataTable.addCell(new Phrase("", tableFont));
                        }
                        if (t.getContainerProperty(next, myUI.getMessage(IndigoMessages.Expense)).getValue() != null) {
                            dataTable.addCell(new Phrase(Settings.dFormat2.format(t.getContainerProperty(next,
                                    myUI.getMessage(IndigoMessages.Expense)).getValue()), tableFont));
                        } else {
                            dataTable.addCell(new Phrase("", tableFont));
                        }
                        dataTable.addCell(new Phrase(t.getContainerProperty(next,
                    ...
                    dataTable.addCell(new Phrase(" ", tableFontBold));
                    dataTable.addCell(new Phrase(" ", tableFontBold));
                    dataTable.addCell(new Phrase(t.getColumnFooter(myUI.getMessage(IndigoMessages.Income)), tableFontBold));
                    dataTable.addCell(new Phrase(t.getColumnFooter(myUI.getMessage(IndigoMessages.Expense)), tableFontBold));
