        ...
        StreamResource.StreamSource source1 = new StreamResource.StreamSource() {
            ...
            public InputStream getStream() {
                ...
                try {
                    ...
                    cell = new PdfPCell(new Phrase(myUI.getMessage(IndigoMessages.MainInfo) + ": ", captionFont));
                    cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cell.setColspan(2);
                    cell.setBorder(0);
                    ...
                    mainInfoTable.addCell(new Phrase(myUI.getMessage(IndigoMessages.Id), ordFont));
                    ...
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                    mainInfoTable.addCell(new Phrase(myUI.getMessage(IndigoMessages.LastName), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
                    mainInfoTable.addCell(new Phrase(employee.getSurname(), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                    mainInfoTable.addCell(new Phrase(myUI.getMessage(IndigoMessages.FirstName), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
                    mainInfoTable.addCell(new Phrase(employee.getName(), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                    mainInfoTable.addCell(new Phrase(myUI.getMessage(IndigoMessages.MiddleName), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
                    mainInfoTable.addCell(new Phrase(employee.getMiddle_name() != null ? employee.getMiddle_name() : "", ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                    mainInfoTable.addCell(new Phrase(myUI.getMessage(IndigoMessages.Gender), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
                    mainInfoTable.addCell(new Phrase(employeeExtraInfo.getGender(), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                    mainInfoTable.addCell(new Phrase(myUI.getMessage(IndigoMessages.DateAndPlaceOfBirth), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
                    ...
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                    mainInfoTable.addCell(new Phrase(myUI.getMessage(IndigoMessages.Nationality), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
                    mainInfoTable.addCell(new Phrase(employeeExtraInfo.getNationality(), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                    mainInfoTable.addCell(new Phrase(myUI.getMessage(IndigoMessages.Citizenship), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
                    mainInfoTable.addCell(new Phrase(employeeExtraInfo.getCitizenship(), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                    mainInfoTable.addCell(new Phrase(myUI.getMessage(IndigoMessages.MartialStatus), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
                    mainInfoTable.addCell(new Phrase(employeeExtraInfo.getMartialStatus(), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                    mainInfoTable.addCell(new Phrase(myUI.getMessage(IndigoMessages.HealthStatus), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
                    ...
                    paragraph = new Paragraph();
                    paragraph.setAlignment(Element.ALIGN_LEFT);
                    paragraph.add(new Phrase(myUI.getMessage(IndigoMessages.School) + ": ", ordFontBold));
                    ...
                    paragraph.add(new Phrase(myUI.getMessage(IndigoMessages.PhoneNumbers) + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getPhones() + "\n", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(IndigoMessages.Address) + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getAddress() + "\n", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(IndigoMessages.SpouseInfo) + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getFamilyInfo() + "\n", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(IndigoMessages.Children) + ": ", ordFontBold));
                    ...
                    paragraph = new Paragraph();
                    paragraph.setAlignment(Element.ALIGN_LEFT);
                    paragraph.add(new Phrase(myUI.getMessage(IndigoMessages.WorkingStatus) + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getWorkingStatus() + "\n", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(IndigoMessages.MainPosition) + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getMainPosition() + "\n", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(IndigoMessages.ExtraPositions) + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getExtraPositions() + "\n", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(IndigoMessages.TotalWorkExperience) + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getWorkExperience() + "\n", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(IndigoMessages.SapatWorkExperience) + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getWorkExperienceSapat() + "\n", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(IndigoMessages.MainBranch) + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getMainBranch() + "\n", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(IndigoMessages.ExtraBranches) + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getExtraBranches() + "\n", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(IndigoMessages.TotalHours) + year + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getHours() + " ", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(IndigoMessages.ExtraHours) + ": ", ordFontBold));
                    ...
                    if (currentUser.isPermitted(Settings.cnCV_Window + ":" + Settings.contract_info)) {
                        paragraph.add(new Phrase(myUI.getMessage(IndigoMessages.CanBeAdvisor) + ": ", ordFontBold));
                        paragraph.add(new Phrase(employeeExtraInfo.getCanBeAdvisor() + "\n", ordFont));
                        paragraph.add(new Phrase(myUI.getMessage(IndigoMessages.ContractType) + ": ", ordFontBold));
                        paragraph.add(new Phrase(employeeExtraInfo.getSalaryCategory() + "\n", ordFont));
                    }
                    paragraph.add(new Phrase(myUI.getMessage(IndigoMessages.Languages) + ": ", ordFontBold));
