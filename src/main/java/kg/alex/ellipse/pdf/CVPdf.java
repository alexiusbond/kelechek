...
import kg.alex.ellipse.domain.Employee;
import kg.alex.ellipse.domain.EmployeeExtraInfo;
        ...
        StreamResource.StreamSource source1 = new StreamResource.StreamSource() {
            ...
            public InputStream getStream() {
                ...
                try {
                    ...
                    paragraph.add(new Phrase(myUI.getMessage(Messages.EllipseWorkExperience) + ": ", ordFontBold));
