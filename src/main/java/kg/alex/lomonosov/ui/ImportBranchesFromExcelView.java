...
import kg.alex.lomonosov.dao.DbBranch;
import kg.alex.lomonosov.dao.DbDefinition;
import kg.alex.lomonosov.dao.DbEmployee;
import kg.alex.lomonosov.dao.DbEmployeeLessons;
import kg.alex.lomonosov.domain.EmployeeBranchesExcel;
import kg.alex.lomonosov.domain.EmployeeLessons;
import kg.alex.lomonosov.excel.ExcelUploader;
import kg.alex.lomonosov.i18n.Messages;
import kg.alex.lomonosov.pdf.BranchCodesPdf;
import kg.alex.lomonosov.utils.FormattedFilterTable;
        ...
        if (source == deleteBtn && yearSelect.getValue() != null) {
            ...
            try {
                myUI.getPage().open(new FileResource(
                                new File(Settings.PATH_TO_UPLOADS + "lomonosov_hr_branches.xlsx")),
                        "_blank", false);
            } catch (Exception e) {
                logger.error(e);
                logger.catching(e);
