...
import kg.alex.lomonosov.domain.Definition;
import kg.alex.lomonosov.domain.EmployeeWork;
import kg.alex.lomonosov.i18n.Messages;
import kg.alex.lomonosov.ui.EmployeeDefinitionView;
...
public class DbEmployeeWork extends BaseDb {
    ...
    public IndexedContainer execSQL(final MyVaadinUI myUI, int employee_id, int own_id,
        ...
        while (result.next()) {
            ...
            item.getItemProperty(myUI.getMessage(Messages.Lomonosov)).setValue(
                    edv.createCheckBox(result.getBoolean("ew.is_sapat"), myUI.getMessage(Messages.Lomonosov)));
    ...
    public IndexedContainer execSQL(final MyVaadinUI myUI, int employee_id, int own_id) throws SQLException {
        ...
        container.addContainerProperty(myUI.getMessage(Messages.Lomonosov), String.class, null);
        ...
        while (result.next()) {
            ...
            item.getItemProperty(myUI.getMessage(Messages.Lomonosov)).setValue(result.getInt("ew.is_sapat") == 1 ?
