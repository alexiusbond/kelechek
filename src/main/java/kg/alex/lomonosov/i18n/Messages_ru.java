package kg.alex.lomonosov.i18n;

public class Messages_ru extends kg.alex.lomonosov.i18n.Messages {

    static final Object[][] contents_ru = {
            // Application
            {AppTitle, "ШКОЛА ЛОМОНОСОВА"},
            // Login Form
            {Language, "Язык"},
            {Level, "Уровень"},
            {GivenBy, "Кем выдан"},
            ...
            {LomonosovWorkExperience, "Стаж работы в Ломоносова"},
            ...
            {ToAge, "Возраст по"},
            {President, "Президент"},
            {LomonosovExam, "Экзамен-Ломоносова"},
