 ...
 */
package kg.alex.lomonosov.reports.accounting;
...
import kg.alex.lomonosov.utils.FormattedTreeTable;
...
public class MonthReportOld implements Button.ClickListener,
    ...
    static final Logger logger = LogManager.getLogger(MonthReportOld.class);
    ...
    public MonthReportOld(final MyVaadinUI ui, final HorizontalSplitPanel splitPanel) {
        this.myUI = ui;
