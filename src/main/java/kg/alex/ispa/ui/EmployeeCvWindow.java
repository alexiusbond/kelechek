...
import kg.alex.ispa.domain.EmployeeExtraInfo;
import kg.alex.ispa.i18n.Messages;
import kg.alex.ispa.pdf.CVPdf;
...
public class EmployeeCvWindow extends Window {
    ...
    public EmployeeCvWindow(MyVaadinUI myUI, Employee employee, EmployeeExtraInfo employeeExtraInfo, String year) {
        ...
        rowNum++;
        rightGl.addComponent(createLabel("<b>" +
                                         myUI.getMessage(Messages.IspaWorkExperience) + ": </b>" + employeeExtraInfo.getWorkExperienceSapat(), null),
                0, rowNum, 1, rowNum);
        rowNum++;
        rightGl.addComponent(createLabel("<b>" +
