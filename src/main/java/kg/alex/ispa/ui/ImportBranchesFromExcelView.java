...
import kg.alex.ispa.dao.DbBranch;
import kg.alex.ispa.dao.DbDefinition;
import kg.alex.ispa.dao.DbEmployee;
import kg.alex.ispa.dao.DbEmployeeLessons;
import kg.alex.ispa.domain.EmployeeBranchesExcel;
import kg.alex.ispa.domain.EmployeeLessons;
import kg.alex.ispa.excel.ExcelUploader;
import kg.alex.ispa.i18n.Messages;
import kg.alex.ispa.pdf.BranchCodesPdf;
        ...
        if (source == deleteBtn && yearSelect.getValue() != null) {
            ...
            try {
                myUI.getPage().open(new FileResource(
                                new File(Settings.PATH_TO_UPLOADS + "ispa_hr_branches.xlsx")),
                        "_blank", false);
            } catch (Exception e) {
                logger.error(e);
                logger.catching(e);
