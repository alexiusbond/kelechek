...
import kg.alex.ispa.domain.EmployeeWork;
...
public class DbEmployeeWork extends BaseDb {
    ...
    public IndexedContainer execSQL(final MyVaadinUI myUI, int employee_id, int own_id,
        ...
        while (result.next()) {
            ...
            item.getItemProperty(myUI.getMessage(Messages.Ispa)).setValue(
                    edv.createCheckBox(result.getBoolean("ew.is_sapat"), myUI.getMessage(Messages.Ispa)));
    ...
    public IndexedContainer execSQL(final MyVaadinUI myUI, int employee_id, int own_id) throws SQLException {
        ...
        container.addContainerProperty(myUI.getMessage(Messages.Ispa), String.class, null);
        ...
        while (result.next()) {
            ...
            item.getItemProperty(myUI.getMessage(Messages.Ispa)).setValue(result.getInt("ew.is_sapat") == 1 ?
