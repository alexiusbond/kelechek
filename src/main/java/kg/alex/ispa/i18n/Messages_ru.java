package kg.alex.ispa.i18n;

public class Messages_ru extends kg.alex.ispa.i18n.Messages {
    ...
    static final Object[][] contents_ru = {
            ...
            {NotificationWrongValueCounter, "Выберите одного законного представителя!"},
            ...
            {Manual, "Мануально"},
            {NbkrCurrency, "НБКР"},
            {DivideButton, "Сформировать план"},
            ...
            {IspaWorkExperience, "Стаж работы в Ispa"},
            ...
            {CopyRelatives, "Копировать с другого ученика"},
            ...
            {InstallmentPlanType, "Тип плана оплат"},
            ...
            {IncomesDefinition, "Определение категорий доходов"},
            ...
            {Saldo, "Сальдо"},
            {SaldoStart, "Сальдо на начало"},
            {SaldoEnd, "Сальдо на конец"},
            {Balance, "Баланс"},
