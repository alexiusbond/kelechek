    ...
    public ContractPdfRu47(final MyVaadinUI ui, StudentInfoPdf st_info, final IndexedContainer instPlanCont) {
        ...
        StreamResource.StreamSource source1 = () -> {
            ...
            try {
                ...
                paragraph.add(new Phrase("При заключении договора и оформлении учащегося в школу требовать оплату за регистрацию и тестирование в размере 7 000 сомов (безвозвратно).", ordFont));
                document.add(paragraph);
                ...
                paragraph.add(new Phrase("Ежегодно в период с 1 апреля по 15 мая заключать договор на следующий учебный год с обязательным внесением 7 000 сомов (безвозвратно) за бронь места или полной предоплаты в размере одномесячной оплаты. В случае незаключения договора учебное место может быть предоставлено другому учащемуся.", ordFont));
                document.add(paragraph);
                ...
                paragraph.add(new Phrase("Ежегодно в период с 1 апреля по 15 мая родители обязаны заключить договор на образовательные услуги на следующий учебный год с обязательным внесением 7 000 сомов (безвозвратно) за бронь места или предоплаты родительского взноса за один месяц. После заключения договора и внесения оплаты, в случае отказа от учёбы, внесённая сумма ", ordFont));
