...
public class ContractPdfRu49 {

    static final Logger logger = LogManager.getLogger(ContractPdfRu49.class);
    ...
    public ContractPdfRu49(final MyVaadinUI ui, StudentInfoPdf st_info, final IndexedContainer instPlanCont) {
        this.myUI = ui;
