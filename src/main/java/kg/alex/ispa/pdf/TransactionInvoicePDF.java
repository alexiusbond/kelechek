...
import kg.alex.ispa.utils.money.WritableSummRuUSD;
    ...
    public TransactionInvoicePDF(final MyVaadinUI myUI, final AccTransaction tr, final String school,
        ...
        StreamResource.StreamSource source1 = () -> {
            ...
            try {
                ...
                final String FONT_LOCATION = "/home/ispa/PT_Sans-Web-Regular.ttf";
                final String FONT_LOCATION_BOLD = "/home/ispa/PT_Sans-Web-Bold.ttf";
