...
import kg.alex.abl.domain.Employee;
import kg.alex.abl.domain.EmployeeExtraInfo;
import kg.alex.abl.i18n.Messages;
import kg.alex.abl.pdf.CVPdf;
...
public class EmployeeCvWindow extends Window {
    ...
    public EmployeeCvWindow(MyVaadinUI myUI, Employee employee, EmployeeExtraInfo employeeExtraInfo, String year) {
        ...
        rowNum++;
        rightGl.addComponent(createLabel("<b>" +
                                         myUI.getMessage(Messages.AblWorkExperience) + ": </b>" + employeeExtraInfo.getWorkExperienceSapat(), null),
                0, rowNum, 1, rowNum);
        rowNum++;
        rightGl.addComponent(createLabel("<b>" +
