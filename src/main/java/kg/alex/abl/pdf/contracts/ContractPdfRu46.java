package kg.alex.abl.pdf.contracts;
...
import kg.alex.abl.dao.DbStudentRelative;
import kg.alex.abl.domain.StudentInfoPdf;
import kg.alex.abl.i18n.Messages;
import kg.alex.abl.utils.Decliner;
    ...
    public ContractPdfRu46(final MyVaadinUI ui, StudentInfoPdf st_info, final IndexedContainer instPlanCont) {
        ...
        StreamResource.StreamSource source1 = () -> {
            ...
            try {
                ...
                paragraph.add(new Phrase("При заключении договора и оформлении учащегося в школу родитель или законный представитель оплачивает за услугу бронирования места, регистрацию и тестирование в размере 5 000 (пять тысяч) сомов (безвозвратно).", ordFont));
                document.add(paragraph);
