...
import kg.alex.abl.utils.money.WritableSummRu;
import kg.alex.abl.utils.money.WritableSummRuSOM;
import kg.alex.abl.utils.money.WritableSummRuUSD;
    ...
    public TransactionInvoicePDF(final MyVaadinUI myUI, final AccTransaction tr, final String school,
        ...
        StreamResource.StreamSource source1 = () -> {
            ...
            try {
                ...
                final String FONT_LOCATION = "/home/abl/PT_Sans-Web-Regular.ttf";
                final String FONT_LOCATION_BOLD = "/home/abl/PT_Sans-Web-Bold.ttf";
                ...
                if (tr.getCashbox().getCurrency_id() == 2) {
