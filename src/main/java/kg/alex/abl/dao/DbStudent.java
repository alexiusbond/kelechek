...
import kg.alex.abl.domain.EducationStatus;
import kg.alex.abl.domain.Student;
import kg.alex.abl.i18n.Messages;
import kg.alex.abl.reports.students.StatusesReport;
import kg.alex.abl.ui.CallsView;
import kg.alex.abl.ui.IssueOrderView;
import kg.alex.abl.ui.StudentDefinitionView;
...
public class DbStudent extends BaseDb {
    ...
    public int exec_insert(Student s) throws SQLException {
        ...
        if (s.getMiddle_name() != null && !s.getMiddle_name().isEmpty()) {
